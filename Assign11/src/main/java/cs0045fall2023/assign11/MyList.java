...
package cs0045fall2023.assign11;
...
public class MyList<T> implements ListInterface<T>
{
	...
	// and the methods that already exist in the class
        ...
        public void swap(int position1, int position2) {
           ...
           this.replace(position1, item2);
           this.replace(position2, item1);
        }
	...
	public static void main(String[] args) {
		...
		// You will need to call your new methods
            ...
            System.out.println(" The occurences removed from January is: " + newList);
             ...
             newList.shuffle();
             System.out.println(" The list after it is shuffle: " + newList);
